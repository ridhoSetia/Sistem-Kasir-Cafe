...
public class LihatRiwayatController {
    ...
    @FXML private Label lblKasirTransaksi;
    ...
    @FXML private VBox panelDetailBox;
    ...
    public void initialize() {
        ...
        tbDetailRiwayatTransaksi.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
    ...
    private void setupKolomTabelAtas() {
        ...
        tbCWaktuRiwayatTransaksi.setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(
    ...
    private void setupKolomTabelBawah() {
        tbCNamaMenuRiwayatTransaksi.setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(
    ...
    private void handleCariData() {
        String keyword = txtCariIDRiwayatTransaksi.getText().trim();
    ...
    @FXML private void handleCariID() { handleCariData(); }
    @FXML private void handleTanggalTransaksi() { handleCariData(); }
